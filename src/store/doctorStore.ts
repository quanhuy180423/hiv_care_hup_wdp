...
export const useDoctorStore = create<DoctorStoreState & DoctorStoreActions>(
  (set) => ({
    ...initialState,
    ...
    closeGenerateScheduleModal: () =>
      set({ isGenerateScheduleModalOpen: false }),
    reset: () => set(initialState),
  })
);

// Legacy exports for backward compatibility
export const useDoctorModalStore = create<{
  isOpen: boolean;
  editingDoctor: Doctor | null;
  openModal: (doctor?: Doctor | null) => void;
  closeModal: () => void;
...
export const useDoctorDrawerStore = create<{
  isOpen: boolean;
  selectedDoctor: Doctor | null;
