      ...
      <div className="flex min-h-screen w-full bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
        ...
        <Sidebar className="border-r border-blue-200/40 shadow-2xl shadow-blue-100/50">
          <SidebarContent className="bg-white/90 backdrop-blur-xl">
            ...
            {/* Footer Actions */}
            <div className="p-4 border-t border-indigo-200/30 bg-indigo-50/30">
              {/* Quick Settings */}
              <div className="flex items-center justify-between mb-4">
                <Button
                  variant="ghost"
                  size="sm"
                  className="flex items-center gap-2 text-slate-600 hover:text-slate-900 hover:bg-indigo-50/50"
                >
                ...
                <Button
                  variant="ghost"
                  size="sm"
                  className="w-8 h-8 p-0 text-slate-600 hover:text-slate-900 hover:bg-indigo-50/50"
                >
        ...
        <main className="flex-1 overflow-auto">
          <div className="min-h-full relative">
            ...
            <div className="relative">
              {/* Top Bar */}
              <div className="sticky top-0 z-10 bg-white/90 backdrop-blur-xl border-b border-indigo-200/30">
