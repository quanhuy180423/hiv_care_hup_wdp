...
const sidebarNav = [
  ...
  },
  {
    ...
    hoverColor: "hover:bg-indigo-50/60",
  ...
  },
  {
    ...
    description: "Thiết lập quyền truy cập",
  },
  {
    ...
    badge: "8",
    description: "Danh sách & phân loại người dùng",
  },
  {
    name: "Quản lý bác sĩ",
    icon: UserCog,
    ...
    badge: "3",
    description: "Thông tin & phân công bác sĩ",
  },
  {
    name: "Quản lý thuốc",
    icon: BarChart3,
  ...
  },
  {
    ...
    hoverColor: "hover:bg-pink-50/60",
  ...
  },
  {
    ...
    hoverColor: "hover:bg-cyan-50/60",
  ...
  },
  {
    ...
    hoverColor: "hover:bg-fuchsia-50/60",
  ...
  },
  {
    ...
    hoverColor: "hover:bg-gray-50/60",
...
export default function SidebarAdmin({ children }: AdminLayoutProps) {
  ...
  return (
    <SidebarProvider>
      <div className="flex min-h-screen w-full bg-gradient-to-br from-blue-50 via-indigo-50 to-slate-50">
        {/* Sidebar */}
        <Sidebar className="border-r border-blue-200/40 shadow-2xl shadow-blue-100/50">
          <SidebarContent className="bg-white/90 backdrop-blur-xl">
            ...
            {/* <div className="relative overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-br from-blue-500/8 via-indigo-500/8 to-slate-500/8" />
                        ...
                        <SidebarMenuItem key={item.name}>
                          <SidebarMenuButton asChild className="p-0">
                            <Link
                              to={item.path}
                              className={cn(
                                "group relative flex items-center gap-4 px-4 py-6 text-sm font-medium rounded-2xl transition-all duration-300",
